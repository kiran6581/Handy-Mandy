...
def userregisterview(request):
    if request.method=="POST":
        ...
        if re.match(password_pattern,password):
            ...
            return render(request,'USER REGISTER.html',{'PasswordError':'Password Must Contain 1 Uppercase, 1 Lowercase, 1 Number, 1 Special Character and Minimum 8 Characters Long'})
